        ...
        elementorFrontend.hooks.addAction("frontend/element_ready/wts-ab-image.default", (function(e, a) {
            e.find(".eae-img-comp-container").imagesLoaded().done((function() {
                ab_style = e.find(".eae-img-comp-container").data("ab-style"), slider_pos = e.find(".eae-img-comp-container").data("slider-pos"), "horizontal" === ab_style ? (separator_width = parseInt(e.find(".eae-img-comp-overlay").css("border-right-width")), function(e) {
                    ...
                    a = e.find(".eae-img-comp-overlay"), t = (t = a.width()) * slider_pos / 100, n(a[0])
                    ...
                    function t(a) {
                        ...
                        function s(e) {
                            e.preventDefault(), r = 1, window.addEventListener("mousemove", o), t.addEventListener("touchmove", c)
                        }
                    ...
                    a = e.find(".eae-img-comp-overlay"), start_pos = a.height(), start_pos = start_pos * slider_pos / 100, t(a[0])
                }(e))
            }))
